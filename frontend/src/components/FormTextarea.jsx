    ...
    >
      <div className="relative">
        ...
        <motion.textarea
          ...
          className={`w-full ${Icon ? 'pl-10' : 'pl-3'} pr-3 py-3 bg-gray-50/50 dark:bg-slate-700/50 border-2 border-gray-200/50 dark:border-slate-600/50 rounded-lg text-gray-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 text-sm transition-all duration-300 focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 dark:focus:ring-red-900/20 focus:bg-white dark:focus:bg-slate-700 backdrop-blur-sm resize-vertical min-h-[80px] ${error ? 'border-red-400 ring-2 ring-red-100 dark:ring-red-900/20' : ''}`}
