...
        <h3 className={`text-xl font-bold mb-4 ${isActive ? 'text-gray-800' : 'text-gray-800 dark:text-white'}`}>
          {step.title}
        </h3>
       <p className={`mb-6 leading-relaxed ${isActive ? 'text-gray-600' : 'text-gray-600 dark:text-gray-400'}`}>
          {step.description}
        </p>
