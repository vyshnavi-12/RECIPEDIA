  ...
  return (
    <div className="recipe-detail-container">
      ...
      <div className="recipe-info">
        <h2>About</h2>
        <p>A delicious and aromatic Indian fish curry made with tender fish pieces simmered in a spiced coconut or tomato-based gravy.</p>

        <h2>Ingredients</h2>
        <ul>
          <li>500g Fish (Pomfret, Kingfish, or any firm fish), cut into pieces</li>
          <li>2 tbsp Oil</li>
        ...
        <ol>
          <li>Heat oil in a pan, add mustard seeds and curry leaves, and let them splutter</li>
          ...
          <li>Gently add fish pieces, cover, and cook for 10 minutes until tender</li>
