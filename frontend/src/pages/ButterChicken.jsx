...
function ButterChicken() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pt-32 pb-16">
      <button onClick={() => navigate('/nonveg')} className="flex items-center text-red-500 hover:text-red-600 mb-6">
        <FaArrowLeft className="mr-2" /> Back
      </button>

      <h1 className="text-3xl md:text-4xl font-extrabold text-gray-800 mb-6">Butter Chicken</h1>
