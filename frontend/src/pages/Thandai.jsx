  ...
  return (
    <div className="recipe-detail-container">
      ...
      <div className="recipe-info">
        <h2>About</h2>
        <p>A refreshing and aromatic Indian beverage made with milk, nuts, and a blend of spices, traditionally enjoyed during festivals like Holi and Mahashivratri.</p>
        ...
        <ol>
          <li>Soak almonds, cashews, pistachios, poppy seeds, fennel seeds, and cardamom in warm water for 2-3 hours</li>
          <li>Blend the soaked ingredients with black pepper and a little milk to form a smooth paste</li>
          <li>Boil milk, add the prepared paste, and mix well</li>
          <li>Stir in sugar, saffron, and rose water (if using), and let it cool</li>
          <li>Refrigerate for 1-2 hours for flavors to blend</li>
          <li>Strain (optional) and serve chilled, garnished with chopped nuts</li>
        </ol>
      </div>
